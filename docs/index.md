...
CFBoundary is a generic toolkit for Cloudflare Python Workers. These docs explain the design constraints, migration strategy, and current API coverage.

## Guides

- [Rationale](rationale.md) — why cfboundary exists and what it deliberately does not do.
- [API surface audit](api-surface-audit.md) — Cloudflare Developer Platform surfaces covered by cfboundary and known gaps.
...
- [Migrating from local wrappers](migrating-from-local-wrappers.md) — moving a project with a local FFI wrapper to cfboundary.
